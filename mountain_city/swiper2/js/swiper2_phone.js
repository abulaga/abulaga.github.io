; (function () {
    ...
    let mobile_lastX;
    let mobile_lastY;
    let mobile_distance_x;
    let mobile_distance_y;


    section2.addEventListener('touchstart', function (e) {
        mobile_x = e.touches[0].clientX;
        mobile_y = e.touches[0].clientY;
    })

    section2.addEventListener('touchmove', function (e) {
        mobile_lastX = e.changedTouches[0].clientX;
        mobile_lastY = e.changedTouches[0].clientY;
    })

    section2.addEventListener('touchend', touchendHandler)
    function touchendHandler() {
        mobile_distance_x = mobile_lastX - mobile_x;
        
        if (mobile_distance_x > 10) {
            if (current_page <= 0) {
                current_page = current_page + 5
            }
            current_page--;
